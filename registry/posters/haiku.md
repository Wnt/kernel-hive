...
Haiku keeps alive an alternative desktop lineage that neither follows Unix conventions wholesale nor imitates Windows. Tracker treats files and metadata as first-class interface objects; Deskbar combines launching and running applications; replicants allow live components to be embedded in other contexts; and the app_server coordinates the system’s recognizable yellow-tabbed windows.
...
The desktop includes Tracker, Deskbar, WebPositive, HaikuDepot, and a Terminal. Window tabs are drawn by Haiku’s app_server.

Menus open with Haiku timing, files are managed by Tracker, and applications run through native system services. The yellow tabs and compact Deskbar identify the lineage immediately.
