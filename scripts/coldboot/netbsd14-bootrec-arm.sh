...
bootrec_scaffold_netbsd14() {
  BR_BOOT_KIND="vmstate"
  BR_CANVAS_W=1024
  BR_CANVAS_H=768
  BR_FPS=30
  BR_HAS_AUDIO=0
  BR_DISKS="disk.qcow2" # the only block device; carries the golden vmstate
  BR_DETECT_TIER=1
  BR_CF_THRESHOLD="0.005"
  BR_SETTLE_MS=3000
  BR_MAX_MS=120000 # cold boot to the settled desktop measured at 49 s
}
