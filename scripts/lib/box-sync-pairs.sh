...
box_sync_load_pairs() {
  ...
  for name in clientcmd.sh osgallery-https-server.py reset-tile.sh install-https-service.sh \
    ...
    usage.py walkin_plane.py deploy_hint.py analytics.py probes.py linecov.py telemetry_routes.py telemetry_stores.py eum_proxy.py traces.py traces_schema.py traces_otlp.py tracecontext.py \
