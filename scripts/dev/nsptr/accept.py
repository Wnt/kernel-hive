...
TARGETS = [
    ...
    (W // 2, H // 2),
    (137, 92), (642, 101), (318, 477), (905, 233), (74, 610), (511, 58),
    (860, 700), (229, 344), (703, 552), (401, 188), (58, 742), (996, 415),
    (167, 266), (588, 633), (777, 119),
]
...
for i, (tx, ty) in enumerate(TARGETS):
    ...
    if i % max(1, len(TARGETS) // fb_checks) == 0:
        ...
        extra = "  fb=%s%s" % (hits, "" if hits == [p] else "  <-- FB DISAGREES")
    print("  %-2d (%4d,%4d)  (%4d,%4d)  %-4d  %-5d  %-6.1f%s"
          % (i, tx, ty, p[0], p[1], e, len(trace) - 1, ms, extra), flush=True)
    time.sleep(0.15)
