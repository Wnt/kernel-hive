...
# stations-manifest.sh — registry-generated recipe for all 111 production
...
#     bash stations-manifest.sh                 # emits all 111 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 111 production tiles into a
...
if [ "$EMITTED" -ne 111 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 111 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 111 production tiles emitted ==="
