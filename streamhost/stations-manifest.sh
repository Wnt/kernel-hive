...
# stations-manifest.sh — registry-generated recipe for all 108 production
...
#     bash stations-manifest.sh                 # emits all 108 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 108 production tiles into a
...
if [ "$EMITTED" -ne 108 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 108 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 108 production tiles emitted ==="
