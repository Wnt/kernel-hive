...
# stations-manifest.sh — registry-generated recipe for all 101 production
...
#     bash stations-manifest.sh                 # emits all 101 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 101 production tiles into a
...
if [ "$EMITTED" -ne 101 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 101 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 101 production tiles emitted ==="
