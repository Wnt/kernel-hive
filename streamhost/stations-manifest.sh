...
# stations-manifest.sh — registry-generated recipe for all 112 production
...
#     bash stations-manifest.sh                 # emits all 112 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 112 production tiles into a
...
if [ "$EMITTED" -ne 112 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 112 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 112 production tiles emitted ==="
