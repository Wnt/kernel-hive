...
# stations-manifest.sh — registry-generated recipe for all 110 production
...
#     bash stations-manifest.sh                 # emits all 110 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 110 production tiles into a
...
if [ "$EMITTED" -ne 110 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 110 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 110 production tiles emitted ==="
