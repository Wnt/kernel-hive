...
# stations-manifest.sh — registry-generated recipe for all 113 production
...
#     bash stations-manifest.sh                 # emits all 113 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 113 production tiles into a
...
if [ "$EMITTED" -ne 113 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 113 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 113 production tiles emitted ==="
