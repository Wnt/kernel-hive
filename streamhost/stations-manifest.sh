...
# stations-manifest.sh — registry-generated recipe for all 107 production
...
#     bash stations-manifest.sh                 # emits all 107 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 107 production tiles into a
...
if [ "$EMITTED" -ne 107 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 107 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 107 production tiles emitted ==="
