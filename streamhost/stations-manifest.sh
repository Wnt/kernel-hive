...
# stations-manifest.sh — registry-generated recipe for all 109 production
...
#     bash stations-manifest.sh                 # emits all 109 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 109 production tiles into a
...
if [ "$EMITTED" -ne 109 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 109 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 109 production tiles emitted ==="
