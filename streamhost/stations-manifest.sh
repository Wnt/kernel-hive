...
# stations-manifest.sh — registry-generated recipe for all 115 production
...
#     bash stations-manifest.sh                 # emits all 115 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 115 production tiles into a
...
if [ "$EMITTED" -ne 115 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 115 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 115 production tiles emitted ==="
