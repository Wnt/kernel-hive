...
# stations-manifest.sh — registry-generated recipe for all 106 production
...
#     bash stations-manifest.sh                 # emits all 106 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 106 production tiles into a
...
if [ "$EMITTED" -ne 106 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 106 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 106 production tiles emitted ==="
