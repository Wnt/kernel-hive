...
# stations-manifest.sh — registry-generated recipe for all 103 production
...
#     bash stations-manifest.sh                 # emits all 103 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 103 production tiles into a
...
if [ "$EMITTED" -ne 103 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 103 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 103 production tiles emitted ==="
