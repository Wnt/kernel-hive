...
# stations-manifest.sh — registry-generated recipe for all 104 production
...
#     bash stations-manifest.sh                 # emits all 104 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 104 production tiles into a
...
if [ "$EMITTED" -ne 104 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 104 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 104 production tiles emitted ==="
