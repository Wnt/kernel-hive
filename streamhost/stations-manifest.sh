...
# stations-manifest.sh — registry-generated recipe for all 114 production
...
#     bash stations-manifest.sh                 # emits all 114 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 114 production tiles into a
...
if [ "$EMITTED" -ne 114 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 114 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 114 production tiles emitted ==="
