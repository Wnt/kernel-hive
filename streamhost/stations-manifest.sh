...
# stations-manifest.sh — registry-generated recipe for all 102 production
...
#     bash stations-manifest.sh                 # emits all 102 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 102 production tiles into a
...
if [ "$EMITTED" -ne 102 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 102 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 102 production tiles emitted ==="
