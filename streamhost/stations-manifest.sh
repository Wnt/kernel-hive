...
# stations-manifest.sh — registry-generated recipe for all 105 production
...
#     bash stations-manifest.sh                 # emits all 105 production tiles' files
...
#
# PARITY GATE: scripts/dev/verify-emit.sh (repo) emits all 105 production tiles into a
...
if [ "$EMITTED" -ne 105 ]; then
  echo "FATAL: emitted $EMITTED tiles but the production roster is 105 — the sweep was truncated." >&2
  exit 1
fi
echo "=== all 105 production tiles emitted ==="
