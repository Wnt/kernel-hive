...
# address 10.99.0.37, and this guest's telnetd and its two root Apaches are the
...
GUEST_IP="${RN_TAP_GUEST_IP:-10.99.0.37}"
...
elif [ "$IF" = suse64rn0 ]; then
  IN_CHAIN="SUSE64RN-IN"
else
  IN_CHAIN="SUSE64RN-IN-$IF"
fi
