...
- Run `scripts/lib/golden-verify.sh its --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/its`
- Rollback plan: TODO
