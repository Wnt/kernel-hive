...
- Run `scripts/lib/golden-verify.sh oberon --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/oberon`
- Rollback plan: TODO
