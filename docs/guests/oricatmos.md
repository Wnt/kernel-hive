...
- Run `scripts/lib/golden-verify.sh oricatmos --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/oricatmos`
- Rollback plan: TODO
