...
- Builder: `scripts/build-guests/tiles/perq.sh`
...
- Run `scripts/lib/golden-verify.sh perq --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/perq`
- Rollback plan: TODO
