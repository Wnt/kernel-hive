...
- Run `scripts/lib/golden-verify.sh gt40 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/gt40`
- Rollback plan: TODO
