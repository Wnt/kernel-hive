...
- Run `scripts/lib/golden-verify.sh redhat62 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/redhat62`
- Rollback plan: TODO
