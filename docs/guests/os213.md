...
- Run `scripts/lib/golden-verify.sh os213 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/os213`
- Rollback plan: TODO
