...
- Run `scripts/lib/golden-verify.sh linux012 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/linux012`
- Rollback plan: TODO
