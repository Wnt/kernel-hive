...
- Public ID / tile directory: `debian22`
...
- Builder: `scripts/build-guests/tiles/debian22.sh`
...
- Run `scripts/lib/golden-verify.sh debian22 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/debian22`
- Rollback plan: TODO
