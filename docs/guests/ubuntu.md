...
- Public ID / tile directory: `ubuntu`
...
- Run `scripts/lib/golden-verify.sh ubuntu --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/ubuntu`
- Rollback plan: TODO
