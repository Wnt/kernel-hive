...
- Run `scripts/lib/golden-verify.sh vision --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/vision`
- Rollback plan: TODO
