...
- Public ID / tile directory: `hpuxvue`
...
- Builder: `scripts/build-guests/tiles/hpuxvue.sh`
...
- Run `scripts/lib/golden-verify.sh hpuxvue --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/hpuxvue`
- Rollback plan: TODO
