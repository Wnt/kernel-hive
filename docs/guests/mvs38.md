...
- Run `scripts/lib/golden-verify.sh mvs38 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/mvs38`
- Rollback plan: TODO
