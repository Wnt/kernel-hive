...
- Run `scripts/lib/golden-verify.sh sculpt --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/sculpt`
- Rollback plan: TODO
