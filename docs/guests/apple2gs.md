...
- Run `scripts/lib/golden-verify.sh apple2gs --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/apple2gs`
- Rollback plan: TODO
