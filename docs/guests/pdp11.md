...
- Run `scripts/lib/golden-verify.sh pdp11 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/pdp11`
- Rollback plan: TODO
