...
- Run `scripts/lib/golden-verify.sh minix2 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/minix2`
- Rollback plan: TODO
