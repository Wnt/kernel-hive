...
- Run `scripts/lib/golden-verify.sh sinclairql --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/sinclairql`
- Rollback plan: TODO
