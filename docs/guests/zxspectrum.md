...
- Run `scripts/lib/golden-verify.sh zxspectrum --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/zxspectrum`
- Rollback plan: TODO
