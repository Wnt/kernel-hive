...
- Run `scripts/lib/golden-verify.sh xenix --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/xenix`
- Rollback plan: TODO
