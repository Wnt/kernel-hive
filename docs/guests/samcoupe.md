...
- Run `scripts/lib/golden-verify.sh samcoupe --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/samcoupe`
- Rollback plan: TODO
