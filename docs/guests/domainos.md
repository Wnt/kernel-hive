...
- Run `scripts/lib/golden-verify.sh domainos --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/domainos`
- Rollback plan: TODO
