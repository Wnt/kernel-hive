...
- Run `scripts/lib/golden-verify.sh zx81 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/zx81`
- Rollback plan: TODO
