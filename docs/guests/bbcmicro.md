...
- Run `scripts/lib/golden-verify.sh bbcmicro --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/bbcmicro`
- Rollback plan: TODO
