...
- Builder: `scripts/build-guests/tiles/a3000.sh`
...
- Run `scripts/lib/golden-verify.sh a3000 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/a3000`
- Rollback plan: TODO
