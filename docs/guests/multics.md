...
- Run `scripts/lib/golden-verify.sh multics --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/multics`
- Rollback plan: TODO
