...
- Run `scripts/lib/golden-verify.sh freebsd411 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/freebsd411`
- Rollback plan: TODO
