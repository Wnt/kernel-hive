...
- Run `scripts/lib/golden-verify.sh atari800xl --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/atari800xl`
- Rollback plan: TODO
