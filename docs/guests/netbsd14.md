...
- Public ID / tile directory: `netbsd14`
...
- Builder: `scripts/build-guests/tiles/netbsd14.sh`
...
- Run `scripts/lib/golden-verify.sh netbsd14 --bake` on a namespaced clone, then
...
- Credentials reference only (never values): `guest/netbsd14`
- Rollback plan: TODO
