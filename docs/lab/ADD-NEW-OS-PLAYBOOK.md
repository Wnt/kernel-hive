...
fully featured (listed, golden, poster, type-in demo) in 10. Sections 1–8 below
...
python3 scripts/stations-registry.py new <id> --like <siblingId> --production --slot auto   # scaffold (see §6.0 for flags)
```
