...
- [`w2kalpha-registration-handoff.md`](w2kalpha-registration-handoff.md) —
  **2026-08-11 session: the station is REGISTERED + LIVE** (60th production
...
- [`w2kalpha-gallery-integration.md`](w2kalpha-gallery-integration.md) — the
  gallery station: what's built/verified, exact remaining registration steps
...
- [`alpha-second-os-candidates.md`](alpha-second-os-candidates.md) — desk survey
  ...
  NT 4.0 / AXP64 2210): media, licensing, and what a second Alpha station costs.
...
the checkpoint is a separate clean snapshot, unaffected).
...
- **Station (production)**: assets `/data/vms/streamhost/assets/w2kalpha/`
  ...
  `root/` lib tree); launcher `/data/vms/streamhost/tiles/w2kalpha/`
