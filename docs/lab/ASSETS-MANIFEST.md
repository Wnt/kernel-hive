...
| `gxt130p-aix432-support.mdf` (**AIX 4.3.2 Support Software for the IBM POWER GXT130P** `[03N4022]` — the display-adapter driver filesets. The GXT130P is a 2D S3-based PCI graphics adapter for the RS/6000, and this disc is the bet that AIX can drive QEMU's emulated S3 Trio natively) | `8b5e4b613731ad110a0da4d16f73d1518295e64035137495dd9db61c5116ecca` *(locally measured 2026-08-26)* | 337 779 936 | `aix432` | Internet Archive item [`AIX4.3.2SupportSoftwareForGXT130P03N4022`](https://archive.org/details/AIX4.3.2SupportSoftwareForGXT130P03N4022), MDF/MDS dump | as above |
