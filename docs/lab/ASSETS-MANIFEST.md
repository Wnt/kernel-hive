...
| atari800xl's composed boot disks `hive.atr` + `hive2.atr` (90 KB each, MyDOS format, **SINGLE density** = 720 x 128-byte sectors — MAME's emulated Atari 1050, `src/devices/bus/a800/atari1050.cpp`, does not implement enhanced density at all, only single and double) — MyPicoDos 4.06N (Matthias Reichl / HiassofT) in `hive.atr`'s boot sectors, carrying Boulder Dash, River Raid, Star Raiders, The Last Word 3.2 (`LASTWORD.XEX` + `LW.CFG`) and our own 18-byte `XBASIC.XEX` cold-start-to-Atari-BASIC stub on D1: (all five fit inside the 90 K ceiling); Dropzone alone on `hive2.atr` (D2:, `-flop2`, no boot code), composed by `dir2atr` from AtariSIO commit `bbccb15265259a1408f36d7ed9b89bb08bbb711d` | source zips: `boulder_dash.zip` sha256 `30b9e8b36fe761a804b2d7af18ed2f52acf3fbe9e2121c3217b10bc8cceb2fc2` (9 752 B); `dropzone.zip` sha256 `b8af400e4d5a6135645d52bb04995ad1955f7eb02700a57197f9c0a4c8149bfb` (22 461 B); `river_raid.zip` sha256 `9db57d32ff2a43a736f6afbda5a15ba38426383104ce8d2948973f57d03dda52` (6 503 B); `star_raiders.zip` sha256 `46d084e428ac9b85be0f0e5fda8f1af28bc4157db528547fc57c73e3102f3e3d` (9 483 B); `LW32.zip` sha256 `d97fc6f4ff412f92e391e253b30bca164e6fcfa5e84e9628d2e5896299f01d4b` (1 662 384 B); composed `hive.atr` sha256 `d77e41f2a11287e1b8aab89e9d6a5e51fe870c19cb10c1f11ba9ccd1782742fa`, 92 176 B; composed `hive2.atr` sha256 `2d68e38b3211038927b4af16587ecd5c3c22459800da00e2135cf78403ad6b4e`, 92 176 B *(both measured stable across two builds, golden-fix stream 2026-09-08)* | 5x source ≤ 1.6 MB, composed 92 176 x2 | `atari800xl.sh` | `/data/assets-staging/atari800xl/media/` (fetch cache + `MANIFEST.sha256`, pinned by sha256) → installed to `/data/vms/streamhost/assets/atari800xl/media/{hive.atr,hive2.atr}` — **PRESENT** | **abandonware-URL** for the four game zips (Fandal's collection, `a8.fandal.cz`, plain single-file XEX builds in wide preservation circulation); **freeware** for The Last Word 3.2, taken from the author's own site (`atari8.co.uk`, Jonathan Halliday / RIF Software). Yoomp! (2007) and Rescue on Fractalus! were considered and **dropped**: both are distributed only as their own bootable ATRs, and MyPicoDos cannot launch a disk image from inside a disk. The 90 KB-per-drive ceiling is the emulated 1050's, not a choice — see the builder header |
