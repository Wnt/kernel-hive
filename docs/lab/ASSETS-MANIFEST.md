...
| atari800xl's composed boot disk `hive.atr` (130 KB, MyDOS format, enhanced density = 1040 x 128-byte sectors) — MyPicoDos 4.06 (Matthias Reichl / HiassofT) in the boot sectors, carrying Boulder Dash, Dropzone, River Raid, Star Raiders, The Last Word 3.2 (`LASTWORD.XEX` + `LW.CFG`) and our own 15-byte `ATARIBAS.XEX` cold-start-to-Atari-BASIC stub, composed by `dir2atr` from AtariSIO commit `bbccb15265259a1408f36d7ed9b89bb08bbb711d` | source zips: `boulder_dash.zip` sha256 `30b9e8b36fe761a804b2d7af18ed2f52acf3fbe9e2121c3217b10bc8cceb2fc2` (9 752 B); `dropzone.zip` sha256 `b8af400e4d5a6135645d52bb04995ad1955f7eb02700a57197f9c0a4c8149bfb` (22 461 B); `river_raid.zip` sha256 `9db57d32ff2a43a736f6afbda5a15ba38426383104ce8d2948973f57d03dda52` (6 503 B); `star_raiders.zip` sha256 `46d084e428ac9b85be0f0e5fda8f1af28bc4157db528547fc57c73e3102f3e3d` (9 483 B); `LW32.zip` sha256 `d97fc6f4ff412f92e391e253b30bca164e6fcfa5e84e9628d2e5896299f01d4b` (1 662 384 B); composed `hive.atr` sha256 `9133c1e0c2b5f4ae8c3f526bd1106597ec7663650e9a54d14ff10263cdec3ae8`, 133 136 B *(measured, media stream 2026-09-08)* | 5x source ≤ 1.6 MB, composed 133 136 | `atari800xl.sh` | `/data/assets-staging/atari800xl/media/` (fetch cache + `MANIFEST.sha256`, pinned by sha256) → installed to `/data/vms/streamhost/assets/atari800xl/media/hive.atr` — **PRESENT** | **abandonware-URL** for the four game zips (Fandal's collection, `a8.fandal.cz`, plain single-file XEX builds in wide preservation circulation); **freeware** for The Last Word 3.2, taken from the author's own site (`atari8.co.uk`, Jonathan Halliday / RIF Software). Yoomp! (2007) and Rescue on Fractalus! were considered and **dropped**: both are distributed only as their own bootable ATRs, and MyPicoDos cannot launch a disk image from inside a disk. The 130 KB ceiling is the Atari 1050's, not a choice — see the builder header |
