...
| SuSE Linux 6.4 `suse-linux-6.4-cd1.iso` (retail six-CD set, CD1 only; archive.org item `suse-linux-6.4`) | sha256 `5a835e4bba03485f17f31d6b8204881a77c1206571b27e8300c889e8bf721a33`, 663 029 760 | `suse64.sh` | `/data/assets-staging/suse64/suse-linux-6.4-cd1.iso` with `MANIFEST.sha256` — **PRESENT + verified**; installed via YaST1 onto `/data/gallery-guests/SUSE64/suse64.qcow2` (golden, station device set) |
