...
| `Kickstart v1.2 r33.180 (1986-10)(Commodore)(A500-A1000-A2000)[!].rom` (staged live at `assets/a1000/kick12-r33.180.rom`) | `87cddb1f499e32758de20145e73031a84bab299e3f6e5c8487e76d02b2ee9d16` *(locally measured 2026-09-09)* | 262 144 | `a1000.sh` | Internet Archive item [`commodore-amiga-firmware`](https://archive.org/details/commodore-amiga-firmware); `/data/vms/sandbox/a1000/media/` with adjacent `MANIFEST.sha256` — **PRESENT + verified** | Amiga Kickstart ROM, still under copyright (Cloanto/Amiga Corp. licence it commercially as Amiga Forever). Private exhibit only: never committed (`.gitignore` covers `*.rom`), never served. |
| `Amiga 1000 ROM Bootstrap (1985)(Commodore)(A1000)[!].rom` (staged live at `assets/a1000/a1000-bootstrap.rom`) | `c67d47d0ff4a4cd29104e96fe7920a2ec13dff4f7f0fbcf7be645e2ae493262c` *(locally measured 2026-09-09)* | 65 536 | `a1000.sh` | Internet Archive item [`commodore-amiga-firmware`](https://archive.org/details/commodore-amiga-firmware); `/data/vms/sandbox/a1000/media/` with adjacent `MANIFEST.sha256` — **PRESENT + verified** | Amiga bootstrap ROM, same copyright status as the Kickstart above. Private exhibit only, never committed or served. Not the boot route this station ships with — see `docs/lab/A1000-WAVE.md` §Walls. |
| `Workbench v1.2 rev 33.56 (1987)(Commodore)(A500)(Disk 1 of 2)(Workbench).adf` (staged live at `$OUT/wb12.adf`, DF0) | `4dfd92a4589346f157593d1a3098966b43e2298c46b749c689b9dc457480be4c` *(locally measured 2026-09-09)* | 901 120 | `a1000.sh` | Internet Archive item [`commodore-amiga-operating-systems-workbench`](https://archive.org/details/commodore-amiga-operating-systems-workbench); `/data/vms/sandbox/a1000/media/` with adjacent `MANIFEST.sha256` — **PRESENT + verified** | Commodore Workbench 1.2, proprietary. Private exhibit only, never committed or served. |
| `Workbench v1.2 rev 33.56 (1987)(Commodore)(A500)(GB)(Disk 2 of 2)(Extras).adf` (staged live at `$OUT/extras12.adf`, DF1) | `7edba9fcbffacde7f1bf94920b76c57e2002ae07b877f26de152ae96c631ba69` *(locally measured 2026-09-09)* | 901 120 | `a1000.sh` | Internet Archive item [`commodore-amiga-operating-systems-workbench`](https://archive.org/details/commodore-amiga-operating-systems-workbench); `/data/vms/sandbox/a1000/media/` with adjacent `MANIFEST.sha256` — **PRESENT + verified** | Commodore Workbench 1.2 Extras, proprietary. Private exhibit only, never committed or served. |
| `medley-full-linux-x86_64-260826-3a14c9aa_260319-9259716e.tgz` (**Interlisp Medley**, full linux x86_64 release: `medley/` loadups+greetfiles+library, `maiko/linux.x86_64/{lde,ldex}`; staged live at `assets/medley/{medley,maiko}` with `MANIFEST.sha256`) | `9e163aaf87a30f0e14e721826172d22c680153bab597c57ef20f39bea3736f76` *(locally measured 2026-09-09)* | 185 512 952 | `medley.sh` | GitHub release [`Interlisp/medley` `medley-260826-3a14c9aa_260319-9259716e`](https://github.com/Interlisp/medley/releases/tag/medley-260826-3a14c9aa_260319-9259716e); `/data/vms/sandbox/medley/media/` with adjacent `MANIFEST.sha256` — **PRESENT + verified** | **MIT** (the Interlisp project's licence for Medley and maiko). Freely redistributable; still not committed (185 MB binary). |
...
| `zoot-i386.iso` (Red Hat Linux 6.2 "Zoot" i386 install CD) | `dc8a1c86cc3389768af207101ecdc8f44e61bc8a5044cfb5fe0efb67eeaa9860` | 671 881 216 | `redhat62.sh` | [`archive.org/download/redhat-6.2_release/zoot-i386.iso`](https://archive.org/download/redhat-6.2_release/zoot-i386.iso); staged `/data/assets-staging/redhat62/zoot-i386.iso` with adjacent `MANIFEST.sha256` | Red Hat Linux 6.2 — GPL and other free licences; Red Hat trademark; private gallery use |
...
### `a3000` — the four Workbench 2.04 ADFs, the golden HDF, and the station-scoped FS-UAE build

| File | Bytes / sha256 | Bytes | Consumer | Provenance | Class |
|---|---|---|---|---|---|
| `Workbench v2.04 rev 37.67 (1991)(Commodore)(Disk 1 of 4)(Workbench).adf` (volume `Workbench2.0` — the `a3000` SYS: root) | `ac6b2529b2896474401ff51c4fcf79464a5f53331b6ad872f0bb721a0a63b8ab` *(locally measured 2026-09-09)* | 901 120 | `a3000` build (`scripts/build-guests/tiles/a3000.sh`; staged `/data/vms/sandbox/a3000/media/`) | Internet Archive item [`commodore-amiga-operating-systems-workbench`](https://archive.org/details/commodore-amiga-operating-systems-workbench), TOSEC set | **preservation-source.** Commodore, still under copyright. Private exhibit only: never committed (`.gitignore` covers `*.adf`), never served, no download affordance. |
| `Workbench v2.04 rev 37.67 (1991)(Commodore)(Disk 2 of 4)(Extras).adf` (volume `Extras2.0` — its `Tools`/`System` subdirs merge onto SYS:) | `3da86648e602f4e0916663d2b4893011423837b2f2b6885e421310338412c02a` *(locally measured 2026-09-09)* | 901 120 | `a3000` build, same tile | same item | as above. |
| `Workbench v2.04 rev 37.67 (1991)(Commodore)(Disk 3 of 4)(Fonts).adf` (volume `AmigaFonts2.0` — its `Fonts/` subdir merges onto SYS:Fonts) | `c04f0ed8016ff2aa458c977722ede02f5e607cdb206a384ae61b081fd694702e` *(locally measured 2026-09-09)* | 901 120 | `a3000` build, same tile | same item | as above. |
| `Workbench v2.04 rev 37.67 (1991)(Commodore)(Disk 4 of 4)(Install).adf` (kept whole under `SYS:Install/` — HDToolBox/FormatHD/InstallHD, not merged into the root) | `c98c97be15f52e25610ee2d4a1fe99807ba9fe11aa81fa0c81fd37cab725bcdd` *(locally measured 2026-09-09)* | 901 120 | `a3000` build, same tile | same item | as above. |
| `Kickstart v2.04 r37.175 (1991-05)(Commodore)(A3000).rom` (the **A3000 Kickstart 2.04** the Workbench 2.04 hardfile boots through; staged live at `assets/a3000/kick37175.A3000.rom` — the SAME dump `amix` stages at `assets/amix/kick37175.A3000.rom`, but this station keeps its own copy) | `563f948af19c09daed1f06b8760221ff4b2789c1690cdcfbce2c941157af23d1` *(locally measured 2026-09-09, identical to `amix`'s copy above)*; md5 `c5fd2322c53d25c0972e6fc54b705d17` | 524 288 | `a3000` runtime | Internet Archive item [`commodore-amiga-firmware`](https://archive.org/details/commodore-amiga-firmware) | **preservation-source.** Never committed (`.gitignore` covers `*.rom`), never served. |
| `a3000-system.hdf` — the **golden disk**, a 256 MiB FFS hardfile composed host-side by `scripts/build-guests/tiles/a3000.sh` from the four ADFs above: Workbench disk 1 as the SYS: root, Extras' `Tools`/`System` merged in, Fonts' `Fonts/` merged into SYS:Fonts, Install kept whole under SYS:Install, and `S/Startup-sequence` replaced with the Workbench disk's own `S/Startup-sequence.HD` (Commodore's hard-disk variant — its "keyboard env var unset" branch has no `PickMap` call at all, unlike the floppy variant's, so the hardfile never shows the first-run KeyMap Selection requester the smoke rig proved on the floppy boot). No statefile: composed and never booted before staging, so the FFS root `bm_flag` stays clean (the `amigaos35` trap this recipe avoids by construction) | *(sha256 measured at build time; volume name `System`, DOS1:ffs)* | 268 435 456 | `a3000` runtime (`streamhost/stations/a3000/x11-runtime.sh` reads it as `hard_drive_0`) | **No external download.** Produced by `scripts/build-guests/tiles/a3000.sh` from the four Workbench 2.04 ADFs above — a real host-side FFS compose, no click-scripted install (unlike `amigaos35`'s OS 3.5 installer, Workbench 2.04 ships pre-installed on its own floppy set) | **preservation-source**, inheriting the ADFs' terms. Never committed, never served, no download affordance. |
| `assets/a3000/fsuae-native/` — the station's **own copy** of FS-UAE 3.2.35, built by `FSUAE_STATION=a3000 scripts/build-guests/emulators/build-fsuae-native.sh` from the fork github.com/Wnt/fs-uae, branch kernel-hive/integrated (upstream v3.2.35 + 2 lab commits), pinned via the third_party/fs-uae-kernel-hive submodule | source tarball `fs-uae-3.2.35.tar.xz` `f3d3cb8d3df34b0b0125c45a5a3e187ff71050be5dc8455cc4505c0380269117` (the builder's own pin). The installed tree is not hashed: `make install` is not byte-reproducible | 3 620 972 (source) | `a3000` runtime — `FSUAE_NATIVE_BIN` in `streamhost/stations/a3000/station.env.fixture` | [`github.com/FrodeSolheim/fs-uae`](https://github.com/FrodeSolheim/fs-uae/releases/tag/v3.2.35), release tarball. **Not shared with `amigaos35` or `amix`**, which keep their own builds: one binary for three stations means a rebuild for one orphans the others' goldens | **freely-fetchable-pinned** — FS-UAE is GPL-2.0. |

### `lisa` — LisaEm 2.0.0, the MAME `lisa2` romset, the LOS 3.1 ProFile image and install floppies

| File | Bytes / sha256 | Bytes | Consumer | Provenance | Class |
|---|---|---|---|---|---|
| `LisaEm-2.0.0-2026.01.25-Linux_x86_64.AppImage` (the emulator; extracted with `--appimage-extract` into `assets/lisa/lisaem/`, run inside the station's nspawn sandbox) | `a9dc5674fbbb0174920b21e8b8a6c543074e239f205af1cdd61ca17628e2ade8` *(locally measured 2026-09-09)* | 5 343 736 | `lisa` build (`scripts/build-guests/tiles/lisa.sh`; staged `/data/vms/sandbox/lisa/media/`) | github.com/arcanebyte/lisaem release 2.0.0 (Ray Arachelian) | **freely-fetchable-pinned**, GPL-2.0. Not committed (binary); the builder re-fetches it. |
| `lisa2.zip` (MAME 0.264 romset: `341-0175-h` + `341-0176-h`, the Lisa 2 boot ROM rev H halves; interleaved high,low into `assets/lisa/rom/lisaboot-revH.rom`, sha256 `4eb245a5a133a202cb07757a7430437a996d91acddfba2c1a3b787e8b5b9d8f5`, 16 384 B) | `3f324d5f041c8f1e70210bf278b4d963550730e75c4fcd24214f4b16bbce3034` *(locally measured 2026-09-09)* | 30 822 | `lisa` build, same tile | Internet Archive item [`mame-0.264-roms-non-merged`](https://archive.org/details/mame-0.264-roms-non-merged) | **preservation-source.** Apple boot ROM, still under copyright. Private exhibit only: never committed (`.gitignore` covers `*.rom`), never served. |
| `LisaEM_LOS3.1with7LisaApps.zip` (inside: `lisaem-profile.dc42`, 10 350 676 B, sha256 `bbc97e82d544050c156057fd80e28a7f66a8e24429e7ed28442fe9d62b84e2ae` — the golden ProFile image, LOS 3.1 with the seven tools, shipped unmodified as `stations/lisa/disk/lisa-profile.dc42.golden`) | `3536d79794b121614015b95705e9f63767a7c37cfb82a307f5c397ab4a563aad` *(locally measured 2026-09-09)* | 5 131 254 | `lisa` build, same tile | Internet Archive item [`apple-lisa-profile-hd-disk-images-for-lisaem-and-idle-lisa-office-system-3.1-lis`](https://archive.org/details/apple-lisa-profile-hd-disk-images-for-lisaem-and-idle-lisa-office-system-3.1-lis) | **preservation-source.** Apple, still under copyright. Private exhibit only: never committed, never served. |
| `los-3.1-en.zip` (five 419 284-byte DC42 install floppies `LOS 3.1 1..5.image` — provenance and a from-scratch rebuild; not used at runtime) | `7cc3b9e1b62ae49ec3e520be915383c63c9516d638570a70599c3e2e798a57f3` *(locally measured 2026-09-09)* | 1 195 960 | `lisa` build, same tile | Internet Archive item [`los-3.1-en`](https://archive.org/details/los-3.1-en) | **preservation-source.** Apple. Private exhibit only. |
...
| apple2e's composed ProDOS hard-disk volume `hive.hdv` (32 MB, `/HIVE`) — ProDOS 2.4.2 (John Brooks) + AppleWorks 3.0 (Claris) in `/AW` + Dazzle Draw 1.2 (Broderbund) in `/DAZZLE` + a tokenized Applesoft `STARTUP` menu, composed with `a2kit` from three source images below | source images: `ProDOS_2_4_2.dsk` sha256 `d1e6fab8d9a25acf6e10ffa15e4120a616898c03613ab87a8e12882b12102543` (143 360 B); `Appleworks30.2mg` sha256 `ea624d6b6fe6fb932fdd0de3035a4714cd3700e3fee7da8ac28b8540dc14b469` (819 264 B); `Dazzle Draw v1.2 (Broderbund-1988).dsk` sha256 `291f54945a1c946ba7985093ce686d01f5d74c7173cf84b0108c0839be0e6191` (143 360 B); composed `hive.hdv` sha256 `0a5a4997ba64bb2d5761260540c86a56761992b65c95fc7f0757f6be3970a8f6` *(measured, golden stream 2026-09-08 rebuild — the earlier `1f54a94b…` was the same volume with the pre-polish STARTUP menu)*, 33 553 920 B (32 MB, fixed by `a2kit mkdsk -k hdmax`) | 3× source ≤ 820 KB, composed 33 553 920 | `apple2e.sh` | `/data/assets-staging/apple2e/media/` (fetch cache, pinned by sha256) → installed to `/data/vms/streamhost/assets/apple2e/media/hive.hdv` — **PRESENT** (this build ran with `STAGE_DIR`/`INSTALL_DIR` pointed at the sandbox's own `/data/vms/sandbox/apple2e-media/` tree because `/data/assets-staging` was not reachable from this agent's mount namespace — an environment gap, not a source-of-truth change; the script's defaults are the canonical paths) | **abandonware-URL**, all three source images from the Asimov mirror `mirrors.apple2.org.za`. ProDOS 2.4.2 and AppleWorks 3.0 are Apple/Claris-abandonware in wide preservation circulation; Dazzle Draw 1.2 is Broderbund abandonware, same footing. A fourth planned entry — 8-Bit Shack's free Angry Birds Apple //e port — is **NOT staged**: `8bitshack.org/post/angrybirds` now serves the site's own 404 page, and the free-download mirror named by a still-indexed secondary source (`www.golombeck.eu/fileadmin/downloads/AngryBirds_V101.dsk`) refuses our TLS SNI / returns 503. `apple2e.sh` has an `ANGRYBIRDS_DSK_URL`/`ANGRYBIRDS_DSK_SHA256` hook to resume once a reachable source turns up; the STARTUP menu OMITS `[3]` entirely (`STARTUP.bas` carries a `@BIRDS@` token the builder substitutes with 1/0, gating the line, the key and the prompt text) so a visitor never reads "not staged yet" on the exhibit |
| domainos's Apollo DN3500 boot PROM + 3C505 firmware set (bitsavers `Apollo/firmware`) | `3500_BOOT_12191_7.bin` sha256 `7f1028f990027eead992204003dc85a6f411484e8a851af677db5dbe4a630584` (65 536 B); 3c505.zip members (unpacked) `0729-12_a.3h` sha256 `ae898709d39eb5ce2eb44d5213fc53b942737df233d384215c7d119d9376c178`, `0729-62_a.3f` sha256 `a831b805d03af895cbf4868bf1c17f8af0b195eafd795215e7eb1882002eb82f`, `3000_3c505_010728-00.bin` sha256 `9983cc0274a4b1976a7278da80790f15561a44a0d23a9a4c88e8fbfd7436df8d`, `3com.9h` sha256 `0b53f3bea9b0d9900c684ce162c6cfad5150add23c953e1b890dc9c363adab9b`, `apollo.9h` sha256 `3e6a3270f5b0676c1cea9f5e52371990873272cbb400ffc571ab9404770b7e23` (all **measured live 2026-09-09**, bitsavers reachable from CT950, matching the staged fallback copies exactly) | ~65 KB + 5×~8 KB | `domainos.sh` | `/data/assets-staging/domainos/roms/` (fetch cache, pinned by sha256; falls back to `/data/vms/sandbox/domainos/media/roms-flat` if bitsavers is unreachable) → staged into the MAME rompath by `stage-romset.py` (matches by sha1 against `-listxml`, so filename casing is cosmetic) — **PRESENT, fetch RUN and verified this wave** | **preservation-source**, bitsavers.org (Apollo firmware dumps, wide preservation circulation). The pristine Domain/OS 10.4.1 winchester image `domain_os_10.4.1.awd` (348 701 760 B, sha256 `9f9ae29c56e456e2520d9107ea2fc30eb8f0dae2d46f6475cc7aa3a92db1f917`, provided-by `andrew_warkentin` via the Virtual OS Museum) halts Normal-mode boot at a 14-day CALENDAR check; `domainos.sh`'s `compose_calendar_disk` runs CALENDAR once in Service mode to produce the station's actual `disk.awd` — **WRITTEN, not yet run this session**; the gallery is private and the winchester bits are never committed |
| samcoupe's composed SAM Coupe boot floppy `hive.mgt` (800K MGT, 819 200 B) — SAMDOS 2.0 + Manic Miner + Mr. Pac + Splat! + The Secretary + a SAM BASIC `auto` menu, composed by `scripts/build-guests/lib/mgtfs.py` and finished by a MAME typing pass | source disks: `SAMDOSVersion2.0.dsk` sha256 `7e4de8ae3aef8bbe913ac55ddef320b45f67f8a4fa2778ee3f0391d1e39dfe60` (819 200 B); `5-In-1 Pack … (EU).sad` sha256 `fdec2e69715dcaaed0241d876838a732fa6e8d6095eb0df947177300c7cfde67` (819 222 B, `.sad` = 22-byte header + the image); `TheSecretary.dsk` sha256 `8597f1138ddca18a135b797f404376c296462cb31d987ff70853b00e232a607a` (819 200 B); composed `hive.mgt` sha256 `818b61d2cec6863920fbc15dd3e215e542dc342b0080affaf7106a32f3a140f1` *(measured, menu-release stream 2026-09-08 — `auto.bas` gained a line 85 `IF INKEY$<>"" THEN GO TO 85` after the key read, so the menu waits for the visitor's key to be RELEASED before acting; the earlier `dcf95631…` build read a still-held key twice — once by the `INKEY$` menu selector, again by the ROM editor a scan frame later — and a browser's B keystroke, held ≥40 ms by the daemon's own key-hold floor, landed as `bNEW` on the BASIC command line)*, 819 200 B | 3× source ≈ 820 KB, composed 819 200 | `samcoupe.sh` | `/data/assets-staging/samcoupe/media/` (fetch cache, pinned by sha256) → installed to `/data/vms/streamhost/assets/samcoupe/media/hive.mgt` — **PRESENT** | **abandonware-URL.** SAMDOS 2.0 from worldofsam.org (the SAM software library; MGT's own DOS, in wide preservation circulation and byte-identical to MAME's `samcoupe_flop` `samdos2` entry, sha1 `a0b6696ea81356bff052daeb7fc49cc4a9f7ff17`). The 5-in-1 Pack from the archive.org `miles-gordon-technology-sam-coupe-champion-collection` item (Revelation Software, 1992). The Secretary from `ftp.nvg.ntnu.no/pub/sam-coupe/disks/utils/` (A. N. Stevens, 1992). The disk carries only what fits: The Secretary's two on-disk manuals (`E_Manual`, `Sec_Man`, 218 sectors together) are left off, and the 5-in-1's Snake Mania and Craft! are not copied. **The bits are never committed** — the gallery is private and only URL, size, sha256 and licence class live in the repo |
| atari800xl's composed boot disks `hive.atr` + `hive2.atr` (90 KB each, MyDOS format, **SINGLE density** = 720 x 128-byte sectors — MAME's emulated Atari 1050, `src/devices/bus/a800/atari1050.cpp`, does not implement enhanced density at all, only single and double) — MyPicoDos 4.06N (Matthias Reichl / HiassofT) in `hive.atr`'s boot sectors, carrying River Raid, Star Raiders and The Last Word 3.2 (`LASTWORD.XEX` + `LW.CFG`) on D1:; Dropzone alone on `hive2.atr` (D2:, `-flop2`, no boot code, currently unreachable from the menu), composed by `dir2atr` from AtariSIO commit `bbccb15265259a1408f36d7ed9b89bb08bbb711d`. **Boulder Dash DROPPED (golden4 stream, 2026-09-08)** — fandal's `boulder_dash.zip` XEX reboots the machine on load; the one alternative tried (archive.org's Iron Software crack, a boot-loader ATR with no DOS directory) could not be extracted as a clean XEX in the time box. **`XBASIC.XEX` (our 18-byte cold-start-to-Atari-BASIC stub) REMOVED (golden5 stream, 2026-09-08)** — it never reached a BASIC READY prompt; the assembly stays in `atari800xl.sh`, disabled behind `SHIP_XBASIC=0` | source zips: `dropzone.zip` sha256 `b8af400e4d5a6135645d52bb04995ad1955f7eb02700a57197f9c0a4c8149bfb` (22 461 B); `river_raid.zip` sha256 `9db57d32ff2a43a736f6afbda5a15ba38426383104ce8d2948973f57d03dda52` (6 503 B); `star_raiders.zip` sha256 `46d084e428ac9b85be0f0e5fda8f1af28bc4157db528547fc57c73e3102f3e3d` (9 483 B); `LW32.zip` sha256 `d97fc6f4ff412f92e391e253b30bca164e6fcfa5e84e9628d2e5896299f01d4b` (1 662 384 B); composed `hive.atr` sha256 `480c7815f2acc7c7c249bb41f7cc9765c5abe6ae983be5dfac2c686019b638d8`, 92 176 B (rebuilt twice, byte-identical); composed `hive2.atr` sha256 `2d68e38b3211038927b4af16587ecd5c3c22459800da00e2135cf78403ad6b4e`, 92 176 B (unchanged) *(golden5 stream 2026-09-08)* | 4x source ≤ 1.6 MB, composed 92 176 x2 | `atari800xl.sh` | `/data/assets-staging/atari800xl/media/` (fetch cache + `MANIFEST.sha256`, pinned by sha256) → installed to `/data/vms/streamhost/assets/atari800xl/media/{hive.atr,hive2.atr}` — **PRESENT** | **abandonware-URL** for the game zips (Fandal's collection, `a8.fandal.cz`, plain single-file XEX builds in wide preservation circulation); **freeware** for The Last Word 3.2, taken from the author's own site (`atari8.co.uk`, Jonathan Halliday / RIF Software). Yoomp! (2007) and Rescue on Fractalus! were considered and **dropped**: both are distributed only as their own bootable ATRs, and MyPicoDos cannot launch a disk image from inside a disk. The 90 KB-per-drive ceiling is the emulated 1050's, not a choice — see the builder header |
...
| Debian GNU/Linux 2.2 "potato" i386 CD1 (`debian-2.2-i386-cd1.iso`, "Official i386 Binary-1"; Debian main is **DFSG-free**, the CD image itself is freely redistributable) | sha256 `2b1d2b18a14ea1f62302aeb98caf1a7b9191a87c3591a42d8bbf0fe5ef1abf1f` *(pin, measured-match)*, 659 271 680 | `debian22.sh` | `/data/assets-staging/debian22/debian-2.2-i386-cd1.iso` — **PRESENT + verified**; staged to `/data/gallery-guests/Debian22/debian-2.2-i386-cd1.iso`, kept attached as the station's IDE CD (apt source, part of the captured golden device set). Internet Archive item [`Debian-GNULinux-2.2-arch-i386-CD`](https://archive.org/download/Debian-GNULinux-2.2-arch-i386-CD/Debian-GNULinux-2.2-arch-i386-CD-1of3.iso) |
| Debian GNU/Linux 2.2 "potato" `navigator-smotif-477_4.77-2.deb` (non-free: Netscape Navigator 4.77 static-Motif binary; **non-free, redistributable as shipped**) | sha256 `4935309549c9b712b3dfcb0134d37eee70e2920759644fea4cadc4e70ca9c783`, 3 238 574 | `debian22.sh` | `/data/assets-staging/debian22/deb/navigator-smotif-477_4.77-2.deb` — **PRESENT + verified**; unpacked into the composed tree. `archive.debian.org` `dists/potato/non-free/binary-i386/` |
| Debian GNU/Linux 2.2 "potato" `navigator-base-477_4.77-2.deb` (non-free: Netscape Navigator 4.77 base files; **non-free, redistributable as shipped**) | sha256 `954c48ee1c7c002c3a44ace1f81fe821d0bb73cb075f966132f91f000a95fc4d`, 7 168 | `debian22.sh` | `/data/assets-staging/debian22/deb/navigator-base-477_4.77-2.deb` — **PRESENT + verified**; unpacked into the composed tree. `archive.debian.org` `dists/potato/non-free/binary-i386/` |
| Debian GNU/Linux 2.2 "potato" `netscape-base-477_4.77-2.deb` (non-free: Netscape 4.77 shared base; **non-free, redistributable as shipped**) | sha256 `6f4502e549583572adc937eec737abcc3fa701f18b18d87645a5f35bc1354f21`, 908 610 | `debian22.sh` | `/data/assets-staging/debian22/deb/netscape-base-477_4.77-2.deb` — **PRESENT + verified**; unpacked into the composed tree. `archive.debian.org` `dists/potato/non-free/binary-i386/` |
| Debian GNU/Linux 2.2 "potato" `netscape-base-4_4.77-1.deb` (contrib: Netscape 4.x wrapper (/usr/lib/netscape/base-4/wrapper); **DFSG-free**) | sha256 `dfc02893ab29f107102d8cd9887cd42784366c02894c70f5ddacd66e3b87f739`, 38 948 | `debian22.sh` | `/data/assets-staging/debian22/deb/netscape-base-4_4.77-1.deb` — **PRESENT + verified**; unpacked into the composed tree. `archive.debian.org` `dists/potato/contrib/binary-i386/` |
| Debian GNU/Linux 2.2 "potato" `libstdc++2.9-glibc2.1_2.91.66-4.deb` (main/oldlibs: libstdc++-libc6.1-1.so.2 that navigator-smotif.real links; **DFSG-free**) | sha256 `1e71b4caa8d408dde0d3669e474905844e45c2bfc121e96840f0bf2437c6d1bd`, 101 806 | `debian22.sh` | `/data/assets-staging/debian22/deb/libstdc++2.9-glibc2.1_2.91.66-4.deb` — **PRESENT + verified**; unpacked into the composed tree. `archive.debian.org` `dists/potato/main/binary-i386/` |
| Debian GNU/Linux 2.2 "potato" `hdparm_3.6-1.deb` (**DFSG-free**; not on CD1) | sha256 `3e0551105e370f916354c6685f848988a664f01a2ba31ab842512ee33b1b20a9`, 18 396 | `debian22.sh` | `/data/assets-staging/debian22/hdparm.deb` — **PRESENT + verified**; unpacked into the composed tree for `hdparm -d1` (PIIX DMA). `archive.debian.org` `dists/potato/main/binary-i386/admin/hdparm_3.6-1.deb` |
| Debian GNU/Linux 2.2 "potato" `base2_2.tgz` (base system tarball, **DFSG-free**) | sha256 `2f53ecb6a1508be95d5351e468b0197e8dca2a58ecf24c8fc1e07765b9817585`, 15 915 492 | `debian22.sh` | `/data/assets-staging/debian22/base2_2.tgz` — provenance/racing-theory input for the `debian22-compose` stream (composes the base system without the interactive installer). `archive.debian.org` `dists/potato/main/disks-i386/current/base2_2.tgz` |
| OpenBSD 7.9 amd64 release set — `cd79.iso`, `bsd`, `bsd.mp`, `bsd.rd`, `base79.tgz`, `man79.tgz`, `xbase79.tgz`, `xfont79.tgz`, `xserv79.tgz`, `xshare79.tgz`, `SHA256`, `SHA256.sig`, `INSTALL.amd64` (**officially-free, ISC/BSD**) | 13 files, each SHA-256-pinned in `openbsd.sh` — pins are the literal values measured on labhost 2026-09-02 (`sha256sum` on the staged copies; not independently re-derived), sizes 1 992 B – 535 342 217 B (`base79.tgz` largest) | `openbsd.sh` | `/data/assets-staging/openbsd79/` — **PRESENT + verified**; mirror `https://ftp.spline.inf.fu-berlin.de/pub/OpenBSD/7.9/amd64/` (cdn.openbsd.org measured 0.8 MB/s from labhost vs 59 MB/s here); installed via real autoinstall(8) over loopback HTTP (site79.tgz composed from the checked-in kit `scripts/build-guests/tiles/openbsd-site/`) to `/data/gallery-guests/OPENBSD/openbsd.qcow2` (pristine, no golden — baked by the `golden` stream) |
...
| SuSE Linux 6.4 `suse-linux-6.4-cd1.iso` (retail six-CD set, CD1 only; archive.org item `suse-linux-6.4`) | sha256 `5a835e4bba03485f17f31d6b8204881a77c1206571b27e8300c889e8bf721a33`, 663 029 760 | `suse64.sh` | `/data/assets-staging/suse64/suse-linux-6.4-cd1.iso` with `MANIFEST.sha256` — **PRESENT + verified**; installed via YaST2 onto `/data/gallery-guests/SUSE64/suse64.qcow2` (golden, station device set) |
| SuSE Linux 6.4 `suse-linux-6.4-cd2.iso` (CD2, only for `suse/kde2/kbase.rpm`) | sha256 `87c994de3ded3f9ffd09c72451dbeb73d9b7af1a58e6b4fc2056cec5174790fa`, 650 475 520 | `suse64.sh` | `/data/assets-staging/suse64/suse-linux-6.4-cd2.iso` in `MANIFEST.sha256` — **PRESENT + verified**; composed with CD1's kde1 rpms into `kde.iso` |
