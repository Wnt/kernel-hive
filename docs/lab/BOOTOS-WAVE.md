...
|---|---|
| `bootos-build` | `scripts/build-guests/tiles/bootos.sh` (fetch pinned upstream, verify SHA-256, compose the 360K qcow2 floppy, framebuffer-verify boot + `dir`), `check-assets.sh`, `docs/lab/ASSETS-MANIFEST.md`, `docs/catalog/os-media-catalog.md`; RUN the builder so the pristine output exists |
