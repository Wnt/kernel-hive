...
| [lab/research/workflow-friction-2026-08.md](lab/research/workflow-friction-2026-08.md) | **PROPOSAL (2026-08-17): workflow friction audit of ten days of agent transcripts** — box-sync drift, manifest clobbering, duplicate sessions, no staging, SSH tax — and a ranked plan: deploy-from-commit (`box-deploy.sh`), UI + station staging tiers, `/data` visible in CT950 + `labrun`, session identity/claim registry, `here.sh`. |
