...
- [`lab/simultaneous-OS-install.md`](lab/simultaneous-OS-install.md) — running two OS integrations at once: publish the stream first, claim ports/slots, land without collisions
