...
| **Interlisp Medley** (Xerox PARC Lisp environment, 1987 line; Interlisp project release medley-260826) | GitHub `Interlisp/medley` releases (✓ — `medley-full-linux-x86_64-260826-3a14c9aa_260319-9259716e.tgz`, 185512952 bytes, sha256 9e163aaf87a30f0e14e721826172d22c680153bab597c57ef20f39bea3736f76) | **MIT** | one tarball: `medley/` (sysouts, greetfiles, library) + `maiko/linux.x86_64/ldex` (the Lisp VM, a native X client) | none — no emulated machine; needs libX11/libbsd on the host | 185 MB | small | works-known (**BUILT → `medley`**, live 2026-09-09; host-native X client under Xvfb, x11 capture + XTEST) | see docs/lab/MEDLEY-WAVE.md |
