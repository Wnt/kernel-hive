...
| PC-BSD 1.5.1 "Da Vinci" (FreeBSD 6.3-RELEASE + KDE 3.5.8, i386, Mar 2008) | https://archive.org/download/pcbsd-1.5.1-x-86-cd-1/PCBSD1.5.1-x86-CD1.iso (✓, fetched + hashed, sha256 `69aa17171e0afe45735c3bb16a398319fa82b3f30a3e1aa3a5d6f25ac4bee0a3`) | officially-free (BSD base; KDE components GPL) | ISO (CD1 only needed) | none | 688 930 816 B (657 MiB) | medium (graphical Qt installer, no unattended path) | works-known, assisted install (station `pcbsd`) | 4 |
