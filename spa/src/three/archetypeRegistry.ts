...
export const OS_BINDINGS: Record<string, OSBinding> = {
  ...
  vision:      { osId: 'vision', archetypeId: 'beige-tower-crt', transport: 'streamhost', accentColor: '#B9A27A', eraLabel: 'TODO(lisa): 1984 · Lisa Office System 3.1' }, // ideal: Apple Lisa 2 one-piece
};
