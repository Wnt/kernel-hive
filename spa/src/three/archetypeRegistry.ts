...
export const OS_BINDINGS: Record<string, OSBinding> = {
  ...
  fmtowns:     { osId: 'fmtowns', archetypeId: 'beige-tower-crt', transport: 'streamhost', accentColor: '#CC3D33', eraLabel: '1995 · Towns OS V2.1 L51 — FM TOWNS (1989)', pointerRel: false },
  oberon:      { osId: 'oberon', archetypeId: 'beige-ibm-pc', transport: 'streamhost', accentColor: '#3d6fb4', eraLabel: '1999 · ETH Native Oberon', pointerRel: false },
  ...
  minix2:      { osId: 'minix2', archetypeId: 'beige-ibm-pc', transport: 'streamhost', accentColor: '#c8a24a', eraLabel: '1997 · Tanenbaum\'s teaching microkernel', pointerRel: false },
  ...
  its:         { osId: 'its', archetypeId: 'beige-tower-crt', transport: 'streamhost', accentColor: '#B23A48', eraLabel: 'TODO(medley): 1987 · Interlisp Medley — the Xerox Lisp machine desktop' }, // ideal: Xerox 1186 Daybreak-style low workstation box with a large portrait-ish CRT (the D-machine Medley ran on)
};
