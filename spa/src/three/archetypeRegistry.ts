...
export const OS_BINDINGS: Record<string, OSBinding> = {
  ...
  lisa:        { osId: 'lisa', archetypeId: 'beige-tower-crt', transport: 'streamhost', accentColor: '#7A8B99', eraLabel: 'TODO(amix): 1992 · Amiga UNIX (AMIX) 2.1' }, // ideal: Amiga 3000 desktop box
};
