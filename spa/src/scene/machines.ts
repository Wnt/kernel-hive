...
// ASSEMBLIES_BY_TILE: split out to assembliesByTile.ts (ts-src 600-line hard
// cap; also removes a recurring per-tile-branch merge hazard — see there).
import { ASSEMBLIES_BY_TILE } from './assembliesByTile';
export { ASSEMBLIES_BY_TILE };
