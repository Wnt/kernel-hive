    ...
    "blocks": [
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The screen shows Windows 2000 Professional, build 2128, logged on to a clean desktop at 1280×1024 with the System Properties dialog open. The three lines under \"Computer:\" are the exhibit's credentials: DEC-221264 is the 21264 Alpha processor, DEC-00Clipper_tsunmp is the ES40's Clipper platform on the Tsunami chipset, and the machine reports 512 MB of RAM. The \"Evaluation copy. Build 2128\" watermark above the clock is Microsoft's own release-candidate marking."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Everything else is exactly the Windows 2000 the world remembers — the same Explorer shell, the same five desktop icons, the same taskbar — which is precisely the point. This was not a port in progress; it was a finished Windows on the wrong side of a business decision."
          }
        ]
      },
      {
