    ...
    "blocks": [
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "In 1970 Xerox opened a research centre in Palo Alto to work out what the company should sell after paper. Three years later, in a building full of people who had just been told to build the office of the future and left largely alone to do it, Chuck Thacker and Butler Lampson designed a computer for one person to use, all day, at a desk."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "That was not what computers were for. A machine of the Alto's cost belonged to a department and was rationed out in timeshare slices; the idea that a whole processor should sit idle waiting for a single human to think was, on any accounting a manager would recognise, absurd. PARC built it anyway, and then built about two thousand of them, and never sold one."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Nearly everything on the wall of this gallery is descended from what happened next. The Alto had overlapping windows and a mouse with buttons. It had a word processor that showed you the page you were going to get. It had Ethernet — Bob Metcalfe's, invented on this machine to connect it to other ones — and a laser printer at the end of it, and electronic mail between the people using them. It had Smalltalk, and inside Smalltalk the idea that a program is a society of objects sending each other messages."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Start with the screen, because it is the thing you can see from across the room: it is standing up. The Alto's display is 606 by 808 dots at roughly 72 to the inch, which is 8.5 by 11 inches, which is a sheet of US Letter paper. That was not a convenient number that fell out of the hardware. It was the specification. The machine was for making documents, so the screen was a page, and it therefore had to be taller than it was wide."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Every document window you have ever scrolled is that decision, still in force."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Then look at what is drawing it. There is no CPU chip in an Alto — no chip in it does the whole job of a processor. There is a datapath built out of a few hundred ordinary logic parts, and a microcode program that hands that datapath to sixteen different "
          },
          {
            "kind": "emphasis",
            "children": [
          ...
          {
            "kind": "text",
            "text": " in priority order. One task repaints the screen straight out of main memory, sixty fields a second. One shifts sectors on and off the removable disk cartridge. One moves Ethernet packets. The lowest-priority task, running only in the gaps the others leave, is the one that executes the instruction set the software is written in."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "So the Alto genuinely gets slower while it is drawing, and faster when the screen is quiet, and that is not a defect — it is the same trick, taken to its logical end, that let a machine costing tens of thousands of 1973 dollars belong to one person."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The Alto Executive: the command prompt, on the Non-Programmer's Disk, exactly as the machine comes up."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "It is text, and it is the right text. Look at the type — it is proportionally spaced, with a serif, on a bitmap screen, at a time when a terminal meant a fixed grid of identical cells. The Alto had no character generator. Every letter is pixels the software drew, which is precisely why it could draw any letter it liked, and precisely why Bravo could show you the page."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Butler Lampson wrote it in 1974; Simonyi took the idea to Microsoft and it became Word. Give it half a minute to load. Its three mouse buttons do three different things, which is the whole argument for a mouse having three: the left button selects a character, the middle one the word you are pointing at, and the right one stretches the selection out to meet you."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "items": [
          [
            ...
            {
              "kind": "text",
              "text": " — Bravo 7.5, the first WYSIWYG word processor. Charles Simonyi and"
            }
          ],
          [
            {
      ...
      },
      {
        ...
        "runs": [
          ...
          {
            "kind": "text",
            "text": " asks the Executive to list what is on the disk, which is the machine's own answer to what else it can do."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Xerox did try to sell the idea, as the Star in 1981, and it is the more famous failure. But the Alto's influence did not travel through a product. It travelled through visits, and papers, and people leaving: to Apple, where the Lisa and the Macintosh made the mouse and the window into things you could buy; to Microsoft, where Simonyi rebuilt Bravo as Word; to 3Com, where Metcalfe sold Ethernet to everyone."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The most quoted line about PARC is Steve Jobs saying that within ten minutes of seeing the graphical interface it was obvious that every computer would work this way one day. The less quoted part is that he was looking at a machine which had already worked that way for six years, in a building where a few hundred people used it every day to do their actual jobs, and which the company that owned it had decided was not a product."
          }
        ]
      }
    ]
    ...
    "blocks": [
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The 6085 is what Xerox did next. Announced in 1985 and built around a new Mesa processor — internally "
          },
          {
            "kind": "emphasis",
            "children": [
          ...
          {
            "kind": "text",
            "text": " — it did the same work as a Star for roughly a third of the money, in a low flat case that fitted under a desk instead of beside it. The software was renamed too: "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": ", a repackaging of the Star environment where the applications were sold as separately licensed options, so a customer could buy the desktop and the document editor and skip the spreadsheet. It also, unlike the Star, could run MS-DOS on an optional coprocessor board in a window, which tells you exactly what the market had become between 1981 and 1985."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The 6085's importance is not that it was new — it is that it was the same. Four years after the Star, and a year after the Macintosh, Xerox was still shipping ideas nobody else had caught up with."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Look at the screen. There is no title bar: a window carries a "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": " along its top edge, with the commands that apply to it — Close, Redisplay, Start, Cancel — as buttons in the same strip. There are no menus in the modern sense; almost every setting in the system is reached through a "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": ", a form you fill in and confirm, and the same idiom covers a paragraph's margins and the machine's own configuration. Across the top of the display runs a "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": " that describes what the system is doing in complete sentences — "
          },
          {
            "kind": "emphasis",
            "children": [
              {
                "kind": "text",
                "text": "Please type your password and then press &lt;NEXT&gt;"
              }
            ]
          },
          {
            "kind": "text",
            "text": " — rather than in status codes."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "And the keyboard is not a PC keyboard. Down its left side ran a column of dedicated keys for the actions the interface is built from: "
          },
          {
            "kind": "strong",
            "children": [
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "A Xerox 6085 with the 19-inch large-screen display: 1152 by 861 pixels, black and white, no greys — the soft mid-tone of the desk is a fifty-percent dither, which is why it shimmers slightly. Running on it is ViewPoint 2.0.5, with the basic workstation, the document editor, the spreadsheet, NetCom and the office accessories all enabled."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The desk is nearly empty on purpose. There is no file server and no Clearinghouse on the other end of this machine's Ethernet — the whole XNS office it was designed to live in is gone — so ViewPoint has done what it was built to do when the network is unreachable: it created a "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": " and carried on. The single icon in the bottom right is the "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": ", and it is the way in: opening it reaches the workstation's own filing, the workspace, and the network that is not there."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The exhibit answers to the machine's own keys. The on-screen keyboard carries the Level-V function block, and each button sends what this emulator expects: NEXT, OPEN, PROPERTIES, MOVE, COPY, SAME, AGAIN, FIND, UNDO, HELP, STOP, DELETE. Clicks want a deliberate press — this machine was never in a hurry."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Xerox kept selling ViewPoint systems into the 1990s, then moved the environment onto ordinary PCs as GlobalView — the Mesa machine reimplemented in software, running under Windows 3.1, the last commercial form of a lineage that began at PARC in 1973 with the Alto. GlobalView was discontinued in the late 1990s and that was the end of it."
          }
        ]
      },
      {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The mottled teal root pattern is not an artifact. It is X11's default root stipple, which SGI simply left in place — a two-colour dither that a 24-bit framebuffer renders as visible speckle, and which anyone who sat in front of one of these machines will recognise immediately."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "This is the second SGI Indy in the hall, and it is here to be compared with the first. The two exhibits run the same IRIX 6.5.22 install on the same emulated hardware except for the processor — and they are drawn by two completely different emulators, written decades apart in different languages by different people, both reconstructing the same 1993 workstation from documentation and dumps. That they agree, pixel for pixel, on what an Indy's desktop looked like is the quiet point of showing them side by side."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "What is left here is the ordinary texture of it: a teal desktop, a docked menu strip, a column of icons, and a Unix workstation waiting for input."
          }
        ]
      }
    ]
    ...
    "blocks": [
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "It came out of Xerox PARC, where the Alto had been running these ideas since 1973, but the Star is not an Alto with a nicer coat of paint. The Alto was a personal machine for computer scientists with an operating system you programmed. The Star was designed "
          },
          {
            "kind": "emphasis",
            "children": [
              {
                "kind": "text",
                "text": "for the person doing the work"
              }
            ]
          },
          {
            "kind": "text",
            "text": " — the designers spent years on a task analysis of office work first, then built an interface around a single rule: "
          },
          {
            "kind": "strong",
            "children": [
              {
                "kind": "text",
                "text": "the screen shows you objects, and you act on them directly."
              }
            ]
          },
          {
            "kind": "text",
            "text": " There is no command language anywhere in it. There is barely any text you have to type that is not the content of your own document."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The hardware was a bit-slice processor codenamed "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": ", in a cabinet the size of a two-drawer filing cabinet that stood on the floor beside your desk, with an 1024×808 black-and-white display, a keyboard, and a two-button mouse on top of it. One workstation cost about "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": ". You could not really use one on its own — the Star was designed as a network of workstations around file, print and mail servers, so a working installation cost several times that."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "It sold in the low tens of thousands, and Xerox is generally reckoned to have lost the personal-computer industry with it."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The usual line is that the Star was ahead of its time. The more useful observation is that it was ahead in ways nobody copied."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Some of it you already know, because you use it every day and have stopped seeing it: icons, folders, windows, WYSIWYG, the mouse, the clipboard, dialogue boxes, the idea that a screen is a place rather than a scroll."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The rest of it never made it out. Look at the keyboard down the left-hand side of the machine: "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": " These are not shortcuts for menu items — there mostly are no menu items. They are the "
          },
          {
            "kind": "emphasis",
            "children": [
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "And running across the top of the display is the "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": ", which describes what the system is doing in complete sentences — "
          },
          {
            "kind": "emphasis",
            "children": [
              {
                "kind": "text",
                "text": "Please type your user-name and then press &lt;NEXT&gt;"
              }
            ]
          },
          {
            "kind": "text",
            "text": " — instead of in status codes. The Star talks to you. Very little since has."
          }
        ]
      },
      {
        ...
        "runs": [
          ...
          },
          {
            ...
            "children": [
              {
                "kind": "text",
                "text": "ViewPoint 2.0 on Services 11.0"
              }
            ]
          },
          {
            "kind": "text",
            "text": " off its original rigid disk, emulated at the hardware level. The display is 1024×808, one bit per pixel: there are no greys on this machine, and the soft mid-tone of the desk is a fifty-percent dither, which is why it shimmers."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The desk is nearly bare, and honestly so. There is no Clearinghouse and no file server on the other end of this machine's Ethernet — the whole XNS office it was built to live in is thirty years gone — so what you get is a workstation's own local world. The icon in the bottom right is the "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": ", and it is the way in: select it, press "
          },
          {
            "kind": "strong",
            "children": [
          ...
          {
            "kind": "text",
            "text": ", and a window lists the Workstation and the Desktop."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Two things are worth knowing before you touch it."
          }
        ]
      },
      {
        ...
        "runs": [
          {
            ...
            "children": [
              {
                "kind": "text",
                "text": "It is not fast, and it was not fast."
              }
            ]
          },
          {
            "kind": "text",
            "text": " A button takes about a second to answer. A real 8010 was not brisk either — this was a machine you thought at, not a machine you flicked through."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "This is the machine. It is still on."
          }
        ]
      }
    ]
    ...
    "blocks": [
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Tru64 carried serious machinery for its day — AdvFS, a journaling file system with online resizing years before Linux had an answer; TruCluster, single-system-image clustering that survived node failures; and the CDE desktop that the commercial UNIX world had standardised on."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The AlphaServer ES40 emulated here is the natural home of this operating system in a way few pairings in the museum can match: Windows on Alpha was a port that died, Linux on Alpha was an enthusiast effort, but Tru64 "
          },
          {
            "kind": "emphasis",
            "children": [
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "The exhibit currently shows Tru64 UNIX "
          },
          {
            "kind": "strong",
            "children": [
    ...
    "blocks": [
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Release Candidate 2 for Alpha survived anyway, the way interesting software does, and became a small legend among collectors: a complete, working, professional operating system for a dead platform — the last Windows for Alpha in existence."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "runs": [
          {
            "kind": "text",
            "text": "Alpha's own story ended in stages — Compaq wound the architecture down and the design teams dispersed, taking their ideas into AMD's Athlon and Opteron and into Intel — but NT's multi-architecture discipline, which Alpha did more than any other platform to keep honest, is why Windows later moved to x86-64 and ARM with its kernel intact. The emulated AlphaServer ES40 running this exhibit is itself a piece of preservation engineering: es40, an open-source emulation of the real machine's firmware, chipset, and devices, faithful enough that an operating system Microsoft never released boots on hardware that no longer needs to exist."
          }
        ]
      }
    ]
