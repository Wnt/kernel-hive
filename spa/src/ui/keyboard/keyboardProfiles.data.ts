...
//  this file (plus its shards keyboardProfiles.data.pc.ts,
//  keyboardProfiles.data.exotic.ts and keyboardProfiles.data.handheld.ts —
//  PROFILES itself is too big for one 600-line file) is the other concern, the actual per-family key layouts
...
import { PROFILES_HANDHELD } from './keyboardProfiles.data.handheld';

// PcFamily, ExoticFamily and HandheldFamily partition Family; the explicit Record<Family, …>
